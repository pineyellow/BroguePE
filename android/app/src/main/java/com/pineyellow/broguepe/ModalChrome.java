...
/** Static chrome helpers shared by title-screen modals (Custom Seed,
...
final class ModalChrome {
     ...
     *  a specialized scrolling container, inline the tail instead. */
    ...
    /** Panel size (width, max height) shared by custom
