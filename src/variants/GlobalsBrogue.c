...
// Brogue version: what the user sees in the menu and title. Android builds
// show the Brogue PE app version while retaining CE recording compatibility.
#ifdef BROGUE_PE_VERSION
#define BROGUE_VERSION_STRING "PE " BROGUE_PE_VERSION
#else
